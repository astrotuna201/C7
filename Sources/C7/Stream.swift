...
extension Sending {
    public func send(_ data: Data, timingOut deadline: Double, completion: @escaping (() throws -> Void) -> Void) {
        completion { try self.send(data, timingOut: deadline) }
    }

    public func flush(timingOut deadline: Double, completion: @escaping (() throws -> Void) -> Void) {
...
extension Receiving {
    public func receive(upTo byteCount: Int, timingOut deadline: Double, completion: @escaping (() throws -> Data) -> Void) {
